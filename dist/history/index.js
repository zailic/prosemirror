...
var Remapping = _require2.Remapping;
...
var History = function () {
  function History(pm, options) {
    var _this3 = this;

    _classCallCheck(this, History);

    if (pm.history) throw new RangeError("ProseMirror instance already has a history object");
    pm.history = this;
  ...
  _createClass(History, [{
    ...
    value: function recordTransform(transform, selection, options) {
      ...
      if (options.addToHistory == false && this.options.selective) {
        ...
        var newGroup = now > this.lastAddedAt + this.options.eventDelay;
    ...
    key: "rebased",
    value: function rebased(newMaps, rebasedTransform, positions) {
      if (!this.options.selective) throw new RangeError("Non-selective history can not be rebased");
...
var historyPlugin = new Plugin(History, {
  depth: 100,
  eventDelay: 500,
  selective: true
});
